...
namespace AppFinalMaratona.Droid
{
    ...
    {
        public static string[] SENDER_IDS = new string[] { "1015386769317" };
    }
    ...
    public class GcmService : GcmServiceBase
    {
        ...
        private MobileServiceClient client = new MobileServiceClient(AzureService.APP_URL);
        ...
        {
            Log.Error("PushHandlerBroadcastReceiver", "Unregistered RegisterationId :" + errorId);
        }
        ...
        protected override void OnRegistered(Context context, string registrationId)
        {
            ...
            MainActivity.Curent.RunOnUiThread(() => Register(push));
        }

        private async void Register(Push push)
        {
            try
            {
